...
CU Boulder: CSCI 5636-001(B) (Fall 2021)

Meeting Time: MWF 11:30-12:20 in ECEE 283

### Remote access via Zoom

* Join via web browser: https://cuboulder.zoom.us/j/92542412498
* Join via Zoom app (using meeting 925 4241 2498)
...
Please join our class Zulip [linked from Canvas](https://canvas.colorado.edu/courses/77070/pages/numerical-solution-of-partial-differential-equations)

### Instructor: [Jed Brown](https://jedbrown.org), [`jed.brown@colorado.edu`](mailto:jed.brown@colorado.edu), ECOT 824

**Office Hours**: Please complete [this survey](https://www.when2meet.com/?12594602-VhMMv) to give your available times. I'm also always happy to meet by appointment.
